...
The cohort is deliberately small. One hundred patients is not enough to train a
deployable model, and the evaluation step is expected to show that. That outcome is the
teaching point, not a defect in the material.
"""
