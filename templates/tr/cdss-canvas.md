...
yazılacak her istemin girdisini oluşturur. Kart NB1'in ilk hücresine girilir ve oradan
sonraki bütün adımlara taşınır.
...
## Kartın ilk kullanımı

Doldurulmuş kart NB1'de kullanılır. Oradaki istem kart üzerinden bir belirtim üretir ve
sonraki bütün defterler o belirtimi esas alır.

İstem, cevaplarınızın eksik ya da kendi içinde tutarsız olduğu yerleri size bildirecek
biçimde yazılmıştır. Üretilen belirtimdeki açık sorular listesini okuyunuz. Kartınızın
zayıf noktaları, kuracağınız sistemin de zayıf noktaları olacaktır.
