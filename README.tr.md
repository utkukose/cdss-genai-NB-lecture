...
Defterlerin tamamı tarayıcıda Google Colab üzerinde çalışır. Kurulum gerekmez, hiçbir veri
kümesi önceden indirilmez.

| | Defter | İçerik |
|---|---|---|
| [![Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/utkukose/cdss-genai-NB-lecture/blob/main/notebooks/tr/NB1_Problem_Karti.ipynb) | **NB1** Problem kartı | Yedi soruyla problemin tanımlanması ve belirtime dönüştürülmesi |
| [![Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/utkukose/cdss-genai-NB-lecture/blob/main/notebooks/tr/NB2_Veri_Hazirlama.ipynb) | **NB2** Veri | MIMIC-IV demo verisinin çağrılması, kohortun kurulması, dört veri türü |
| [![Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/utkukose/cdss-genai-NB-lecture/blob/main/notebooks/tr/NB3_Model_ve_Degerlendirme.ipynb) | **NB3** Model | Hasta düzeyinde ayrım, temel model ve dürüst değerlendirme raporu |
| [![Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/utkukose/cdss-genai-NB-lecture/blob/main/notebooks/tr/NB4_Aciklanabilirlik.ipynb) | **NB4** Açıklanabilirlik | Küresel önem, kesin yerel katkılar ve açıklamanın eleştirisi |
| [![Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/utkukose/cdss-genai-NB-lecture/blob/main/notebooks/tr/NB5_Guvenlik_ve_Yonetisim.ipynb) | **NB5** Güvenlik | Çekimserlik, dağılım kayması, kırmızı takım, yönetişim belgeleri |
| [![Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/utkukose/cdss-genai-NB-lecture/blob/main/notebooks/tr/NB6_Web_Arayuzu.ipynb) | **NB6** Arayüz | Web üzerinden çalışan demo arayüzü |

### Defterler nasıl çalışıyor

Kodu siz yazmazsınız. Her adımda bir istem verilir. İstem bir üretken yapay zekâ aracına
aktarılır, aracın ürettiği kod istemin altındaki boş hücreye yapıştırılır ve çalıştırılır.

Her yapıştırma hücresinin ardından bir kontrol hücresi gelir. Her istemin sonunda KABUL
ÖLÇÜTLERİ başlıklı bir bölüm bulunur; bu bölüm kodun hangi adla hangi değişkeni üretmesi
gerektiğini belirler ve kontrol hücresi tam olarak bunu sınar. Bir işi dil modeline
devrederken arayüzü tanımlamak kullanıcının sorumluluğundadır ve kabul ölçütü içermeyen bir
istem, denetlenmesi mümkün olmayan bir kod üretir.

Kontrol yoğunluğu defterler ilerledikçe azalır. NB2'de on bir kontrol bulunur, NB6'da bir
tane; denetim sorumluluğu materyal ilerledikçe katılımcıya geçer.

Kurduğunuz sistemi değerlendiren, çizen ve zorlayan hücreler sabittir.

**Bir koşul.** Defterler `workshop/` klasöründeki modülleri `raw.githubusercontent.com`
üzerinden çeker; bu nedenle deponun herkese açık olması gerekir. Özel bir depoda bu çağrı
404 döner ve modüllerin Colab oturumuna elle yüklenmesi gerekir.

**Dersten önce denenecek.** NB2'nin ilk iki hücresini çalıştırınız. Mekân PhysioNet
adresini engelliyorsa bağlantı denetimi bir saniye içinde hata verir ve sentetik veri
şeridine geçmek için vakit kalır.
