...
├── workshop/
│   └── cdss_kit.py                     Kodu defterler arasında taşır ve kontrolleri çalıştırır
├── notebooks/
...
kodu istemin altındaki boş hücreye yapıştırır ve çalıştırırsınız.

Her istemin sonunda BEKLENEN SONUÇ başlıklı bir bölüm bulunur; kodun ne üretmesi gerektiğini
yazar. Ardından gelen kontrol hücresi tam olarak bunu sınar ve eksik varsa bildirir.
Bildirimi yapay zekâ aracına geri verip kodu yeniden ürettirirsiniz. İlk denemede tutmaması
olağandır.

Kodu anlamanız beklenir ve her adımdan sonra kısa bir Python notu gelir. Notlar hiçbir ön
bilgi varsaymaz ve az önce gördüğünüz yapıyı açıklar: Kütüphane nedir, tablo nedir, fonksiyon
ve açıklama metni ne işe yarar, ekrana yazmak ile geri vermek arasındaki fark nedir, sözlük,
döngü, nesne ve yöntem, erken dönüş, geri çağrı.
...
Tek bir modül: `workshop/cdss_kit.py`. Kodu defterler arasında taşır ve kontrolleri
çalıştırır. İçinde klinik karar destek mantığı yoktur; onu siz yazarsınız.
...
Eğitimi projesi kapsamında Akdeniz Üniversitesi ev sahipliğinde gerçekleştirilmiştir. Dr. Köse
davet ve organizasyon için proje yürütücülerine ve düzenleme kuruluna, klinik sorularıyla
atölyenin biçimlenmesine katkı veren katılımcılara teşekkür eder.
