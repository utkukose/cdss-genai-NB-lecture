...
Açık erişimli altı veri kümesi hazırlanmıştır; katılımcı NB1'de birini seçer ve sonraki
bütün adımlar seçime göre ilerler.

| Kod | Tür | Veri kümesi | Erişim |
|---|---|---|---|
| `mimic-yogun-bakim` | tablo | MIMIC-IV demo, 100 hasta | HTTPS, kimlik doğrulaması yok |
...
EKG kümesi klinik demo ile aynı 92 hastayı içerdiğinden o yolda aynı sonuç bu kez sinyalden
tahmin edilir ve iki yol karşılaştırılabilir. MedMNIST kümelerinde hasta kimliği bulunmaz;
defter bunu gizlemek yerine yazar. Kimlik doğrulaması istemeyen klinik not kümesi
bulunmadığından metin yolunda veri üretilir.
